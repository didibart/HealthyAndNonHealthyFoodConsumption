...
380
healthy preferences
count turtles with [food-preferences = 0]
17
1
11
...
count turtles with [food-preferences = 1]
17
1
11
...
"" ""
PENS
"default" 1.0 0 -2674135 true "" "plot sum [tunhealthy] of turtles"
"pen-1" 1.0 0 -11085214 true "" "plot sum [thealthy] of turtles"
...
setup button configures the stores and distributes turtles randomly
num-turt slider set the number of turtles
earnings button set the wage each turtle is going to get on each 180 ticks
hungry-threshold slider set the metabolism value which tells the turtle to go to the store
payday slider sets the tick count to which turtles get paid 
...
Complexity Explorer 2024 ABM course
Diego Díaz Córdova
...
@#$#@#$#@
<experiments>
  <experiment name="healthy non healthy - 1 - earnings 25" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>sum [tunhealthy] of turtles</metric>
    <metric>sum [thealthy] of turtles</metric>
    <metric>count turtles with [food-preferences = 0]</metric>
    <metric>count turtles with [food-preferences = 1]</metric>
    <enumeratedValueSet variable="payday">
      <value value="30"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="hungry-threshold">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-turt">
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="earnings">
      <value value="25"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="healthy non healthy - 2 - earnings 85" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>sum [tunhealthy] of turtles</metric>
    <metric>sum [thealthy] of turtles</metric>
  ...
  <experiment name="healthy non healthy - 3 - earnings 89" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>if ticks = 5001 [stop]
go</go>
    <metric>sum [tunhealthy] of turtles</metric>
    <metric>sum [thealthy] of turtles</metric>
    <metric>count turtles with [food-preferences = 0]</metric>
  ...
  <experiment name="healthy non healthy - 4 - earnings 90" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>if ticks = 5001 [stop]
go</go>
    <metric>sum [tunhealthy] of turtles</metric>
  ...
  <experiment name="healthy non healthy - 5 - earnings 91" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>if ticks = 5001 [stop]
go</go>
    <metric>sum [tunhealthy] of turtles</metric>
  ...
  <experiment name="healthy non healthy - 6 - earnings 92" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>if ticks = 5001 [stop]
go</go>
    <metric>sum [tunhealthy] of turtles</metric>
